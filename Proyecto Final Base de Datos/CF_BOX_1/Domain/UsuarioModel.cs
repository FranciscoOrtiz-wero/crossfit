namespace Domain
{
    ...
    public class UsuarioModel
    {
        ...
        public void InsertarPersonal(string Nombre, string Apellido, int Edad, string Direccion, int Telefono, string correo, string puesto, int idRegistro)
        {
            int Id;
        ...
        public void InsertarCliente(string Nombre, string Apellido, int Edad, string Direccion, int Telefono, string correo, int idDetalles)
        {
            int Id;
