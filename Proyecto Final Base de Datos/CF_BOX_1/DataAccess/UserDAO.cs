namespace DataAccess
{
    ...
    public class UserDAO : ConnectionToSQL
    {
        ...
        public void InsertarPersonal(int idPersonal, string Nombre, string Apellido, int Edad, string Direccion, int Telefono, string correo, string puesto, int idRegistro)
        {
            using (var connection = GetConnection())
            {
                connection.Open();
        ...
        public void EditarPersonal(int idPersonal, string Nombre, string Apellido, int Edad, string Direccion, int Telefono, string correo, string puesto, int idRegistro)
        {
            using (var connection = GetConnection())
            {
                connection.Open();
        ...
        public void EditarClases(int idClases, string Dia, string HoraInicio, string HoraFinaliza, int idRegistro)
        {
            using (var connection = GetConnection())
            {
                ...
                {
                    command.Connection = connection;
                    command.CommandText = "Update Clases set idClases=" + idClases + ", Dia='"+Dia+"' HoraInicio='" + HoraInicio + "', HoraFinaliza='" + HoraFinaliza + "', idRegistro=" + idRegistro + " WHERE idClases = " + idClases + " )";
                    command.ExecuteNonQuery();
                }
            }
        }
        ...
        public void InsertarCliente(int idCliente, string Nombre, string Apellido, int Edad, string Direccion, int Telefono, string correo, int idDetalles)
        {
            using (var connection = GetConnection())
            {
                connection.Open();
        ...
        public void EditarCliente(int idCliente, string Nombre, string Apellido, int Edad, string Direccion, int Telefono, string correo, int idDetalles)
        {
            using (var connection = GetConnection())
            {
                connection.Open();
                ...
                {
                    command.Connection = connection;
                    command.CommandText = "Update Cliente set idCliente=" + idCliente + ", Nombre='" + Nombre + "', Apellido='" + Apellido + "', Edad=" + Edad + ", Direccion='" + Direccion + "', Telefono=" + Telefono + ", correo='" + correo + "', idDetalles=" + idDetalles + " WHERE idDetalles = " + idDetalles + " )";
                    command.ExecuteNonQuery();
                }
            }
        }
