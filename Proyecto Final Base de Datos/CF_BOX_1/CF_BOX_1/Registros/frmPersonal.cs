    ...
    public partial class frmPersonal : Form
    {
        ...
        private void ToolStripGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (PageAction == "ADD")
            {
                ...
                usuarioModel.InsertarPersonal(txtNombre.Text, txtApellido.Text, Convert.ToInt32(txtEdad.Text), txtDireccion.Text, Convert.ToInt32(txtTelefono.Text), txtCorreo.Text, txtPuesto.Text, Convert.ToInt32(txtIDregistro.Text));
                this.personalTableAdapter.Fill(this.dsPersonal.Personal);
                EstablecerEstado(false);
            }
            else
            {
                if (PageAction == "EDIT")
                {
                    ...
                    UsuarioModel usuarioModel = new UsuarioModel();
                    usuarioModel.EditarPersonal(ID, txtNombre.Text, txtApellido.Text, Convert.ToInt32(txtEdad.Text), txtDireccion.Text, Convert.ToInt32(txtTelefono.Text), txtCorreo.Text, txtPuesto.Text, Convert.ToInt32(txtIDregistro.Text));
                    EstablecerEstado(false);
                }
            }
        }
