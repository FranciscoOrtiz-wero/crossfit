    ...
    public partial class frmCliente : Form
    {
        ...
        private void ToolStripGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (PageAction == "ADD")
            {
                ...
                usuarioModel.InsertarCliente(txtNombre.Text, txtApellido.Text, Convert.ToInt32(txtEdad.Text), txtDireccion.Text, Convert.ToInt32(txtTelefono.Text), txtCorreo.Text, Convert.ToInt32(txtIDetalles.Text));
                this.clienteTableAdapter.Fill(this.dsClientes.Cliente);
                EstablecerEstado(false);
            }
            else
            {
                if (PageAction == "EDIT")
                {
                    ...
                    UsuarioModel usuarioModel = new UsuarioModel();
                    usuarioModel.EditarCliente(ID, txtNombre.Text, txtApellido.Text, Convert.ToInt32(txtEdad.Text), txtDireccion.Text, Convert.ToInt32(txtTelefono.Text), txtCorreo.Text, Convert.ToInt32(txtIDetalles.Text));
                    EstablecerEstado(false);
                }
            }
        }
